...
function Translator(props: IProps) {
  ...
  const { translateSpokenToSigned, spokenLanguages } = useTranslationService();
    ...
    <Layout>
      <div className="mx-auto rounded-lg">
        ...
        <p className="mb-4 text-lg">
          ...
          : Converts written text into accurate sign language animations,
          enabling easy understanding for hearing-impaired users.
        </p>
        <p className="mb-12 text-lg">
          <span className="text-[#48C9B0] font-bold">
            Sign Language to Text
          </span>{" "}
          : Users can express sign language through a camera, which is
          recognized and converted back into text.
        </p>
        <hr className="mb-6 border-gray-300" />
              ...
              <div className="w-[580px] bg-white border border-gray-300 rounded-lg p-6">
                ...
                >
                  ...
                  <select
                    ...
                    style={{ flex: 1, padding: "10px" }}
                  >
                    {Object.entries(spokenLanguages).map(
                      ([langCode, langName]) => (
                  ...
                  <button
                    ...
                    className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-md mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={loading}
                  >
