...
function Login(props: IProps) {
  ...
  return (
    <section className={`login flex flex-col bg-white overflow-hidden ${props.className || ''}`}>
      {/* Login form section with authentication options */}
      <div className="xs:mt-[22px] xs:mr-0 xs:mb-20 xs:ml-[13px] tn:mt-[22px] tn:mx-auto tn:mb-[50px] w-[92.43%] flex flex-col gap-y-[50px] max-w-[1330.987548828125px] mt-[22px] mb-[91px] ml-[13px]">
        ...
        <div className="md:flex-col md:items-center md:gap-y-[30px] w-[93.16%] flex justify-between gap-x-2.5 ml-auto">
          <div className="md:w-full md:min-w-[unset] md:m-0 w-[512px] flex flex-col z-[1] min-w-0 mt-[92px] mb-[134px]">
            {/* Main login form container with input fields */}
            ...
            <div className="flex flex-col relative mt-[49px]">
              <input
                ...
                className="bg-white rounded outline outline-[rgb(121,116,126)] outline-1 outline-offset-[-1px] h-[56px] px-3 text-[16px] leading-tight"
                placeholder="Email"
              />
            </div>
            ...
            <div className="flex flex-col bg-white rounded outline outline-[rgb(121,116,126)] outline-1 outline-offset-[-1px] relative mt-6">
              <input
                ...
                className="bg-white rounded outline outline-[rgb(121,116,126)] outline-1 outline-offset-[-1px] min-h-[56px] px-3"
            ...
            <div className="flex justify-center mt-4 mx-auto">
              <span className="font-bold text-[14px] leading-[1.28] font-PlusJakartaSans text-black text-center">
                ...
                <span className="font-bold text-[rgb(255,134,130)]">Sign up</span>
              </span>
            </div>
            ...
            <div className="tn:flex-col tn:items-center tn:gap-y-[30px] tn:gap-x-2 flex gap-x-4 mt-10">
              ...
              <img className="tn:w-full tn:min-w-[unset] tn:max-w-[160px] rounded outline outline-[rgb(81,93,239)] outline-1 outline-offset-[-1px] w-40 object-cover min-w-0" src={'/assets/de9f3005456292fe90e42f79e20e10dc.svg'} alt="alt text" />
              <img className="tn:w-full tn:min-w-[unset] tn:max-w-[160px] rounded outline outline-[rgb(81,93,239)] outline-1 outline-offset-[-1px] w-40 object-cover min-w-0" src={'/assets/1e58727831e4d8eac8c2399d37191fbc.svg'} alt="alt text" />
              <img className="tn:w-full tn:min-w-[unset] tn:max-w-[160px] rounded outline outline-[rgb(81,93,239)] outline-1 outline-offset-[-1px] w-40 object-cover min-w-0" src={'/assets/28d74fcb9395a994ef47ddfa4d563aeb.svg'} alt="alt text" />
            </div>
          </div>

          <img className="md:w-full md:min-w-[unset] md:max-w-[563px] w-[563px] object-cover min-w-0" src={'/assets/fbbd5af3dcd1a864ccd3cfdf2a8a8082.png'} alt="alt text" />
        </div>
      </div>
    </section>
  );
